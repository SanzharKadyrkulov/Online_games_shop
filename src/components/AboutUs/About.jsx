...
const About = () => {
    return (
        <div
            style={{
                backgroundImage: `url(https://vse-frazi.ru/wp-content/uploads/2018/02/2018-02-05_112416.jpg)`, backgroundSize: "450px", display: 'flex', justifyContent: 'center', justifyContent: 'space-between'
            }}>
